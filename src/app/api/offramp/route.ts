...
export async function POST(req: NextRequest) {
  try {
    ...
    const redirectUrl = `https://sandbox.coinbase.com/v3/sell/input?sessionToken=${sessionToken}&defaultAsset=ETH&fiatCurrency=USD&redirectUrl=${ALLOWED_ORIGIN}&partnerUserId=12345`;
